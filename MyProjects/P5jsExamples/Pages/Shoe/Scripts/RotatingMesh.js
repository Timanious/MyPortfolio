const sketch = function (containerDivId,modelPath,texturePath) 
{
    return function (p) 
    {
        ...
        p.preload = function () 
        {
            ...
            texture = p.loadImage(texturePath);

            // model = p.loadModel('./3DModels/OldShoe.obj', true);
            // texture = p.loadImage('./Textures/Shoe-Textures/Shoe-Albedo.jpg');
        }
